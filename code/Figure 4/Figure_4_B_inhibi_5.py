...
if __name__ == '__main__':
    for NUMBER_OF_TEMPERATURE1 in range(0, MAX_NUMBER_TEMPERATURES1):
        ...
        output_folder = "results_output_EI_deficiency5/"
        if not os.path.exists(output_folder):
            os.makedirs(output_folder)

        output_file = os.path.join(output_folder, "X1_and_average_res_by_def_e_i5.xlsx")
    ...
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_5_in_neuron_E-I_deficiency_no_inner_comparison" + ".pdf",
                format='pdf')
