...
if __name__ == '__main__':
    for NUMBER_OF_TEMPERATURE1 in range(0, MAX_NUMBER_TEMPERATURES1):
        ...
        for NUMBER_OF_TEMPERATURE in range(0, MAX_NUMBER_TEMPERATURES):
            ...
            for def_i_e in [0, 25, 50, 75]:
                ...
                result_df[f"X1_def_i_e_{def_i_e}"] = X1[NUMBER_OF_TEMPERATURE1]
                result_df[f"average_res_def_i_e_{def_i_e}"] = average_res
                result_df[f"std_res_def_i_e_{def_i_e}"] = std_res
    ...
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_5_in_neuron_I-E_deficiency_no_inner_comparison" + ".pdf",
                format='pdf')
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_5"
                            ""
                            "_in_neuron_I-E_deficiency_no_inner_comparison" + ".svg",
                format='svg')
    plt.show()