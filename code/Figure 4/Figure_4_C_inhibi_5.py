...
######################################################################
capacities = []
folder_name = "50 I-E deficiency/inhibi_5"
if __name__ == '__main__':
    ...
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_5_in_neuron_I-E_deficiency" + ".pdf",
                format='pdf')
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_5_in_neuron_I-E_deficiency" + ".svg",
                format='svg')
