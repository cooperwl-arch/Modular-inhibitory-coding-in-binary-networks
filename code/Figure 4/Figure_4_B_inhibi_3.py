...
######################################################################
capacities = []
folder_name = "50 E-I deficiency/inhibi_3"
if __name__ == '__main__':
    ...
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_3_in_neuron_E-I_deficiency" + ".pdf",
                format='pdf')
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_3_in_neuron_E-I_deficiency" + ".svg",
                format='svg')
    plt.show()