...
def save_capacity_raw_data(res, x, def_i_e, folder_name):
    ...
    df.to_csv(
        os.path.join(
            raw_data_folder,
            f"raw_data_def_e_i_{def_i_e}.csv"
        )
    )
...
######################################################################
capacities = []
folder_name = "50 I-E deficiency/inhibi_3"
...
if __name__ == '__main__':
    ...
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_3_in_neuron_I-E_deficiency" + ".pdf",
                format='pdf')
    plt.savefig(file_name + "/capacity_50_ex-neurons_system_3_in_neuron_I-E_deficiency" + ".svg",
                format='svg')
