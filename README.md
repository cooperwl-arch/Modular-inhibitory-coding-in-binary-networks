...
50 E-I deficiency/inhibi_{i}/raw_data/raw_data_def_e_i_{def_e_i}.csv (Figure 4B)

50 I-E deficiency/inhibi_{i}/raw_data/raw_data_def_i_e_{def_i_e}.csv (Figure 4C)

(def_e_e/def_e_i/def_i_e=0, 25, 50, 75)
